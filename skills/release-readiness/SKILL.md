...
description: Prepares production launches. Use when preparing to deploy to production, or when asking what needs to be in place before shipping. Use when you need a pre-launch checklist, when setting up monitoring, when planning a staged rollout, or when you need a rollback strategy. Triggered by deploy, release, PR, or production tasks.
license: Complete terms in LICENSE.txt
---

<!--
Sourced from `shipping-and-launch` in https://github.com/addyosmani/agent-skills
(MIT License), renamed to `release-readiness` to match this project's SDLC
skill catalog. The "See Also" pointers to `../../references/*.md` files and
the sibling `observability-and-instrumentation` skill from the source repo —
none included in this catalog — were removed rather than left as broken
paths.
-->
